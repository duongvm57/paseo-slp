...
try {
  ...
  const commandFlags = { install: ['--paseo-home', '--apply', '--reload'], uninstall: ['--apply', '--reload'], upgrade: ['--from', '--apply', '--reload'], init: ['--routing-from', '--apply'], materialize: ['--from', '--apply', '--include', '--paseo-home'], routes: ['--paseo-home', '--out'], inventory: ['--paseo-home'], agents: ['--paseo-home'], monitor: [], notebook: ['--paseo-home'], prepare: ['--check', '--emit', '--schema', '--out'], 'prepare-handoff': ['--check', '--emit', '--schema', '--out'], 'route-decide': ['--paseo-home', '--schema', '--out'], status: ['--paseo-home'], 'local-target': ['--paseo-home'] };
  ...
  } else throw new Error('Usage: slp.mjs identity | snapshot <repo> | install [absolute-dir] [--paseo-home <absolute-home>] [--apply] [--reload] | upgrade <absolute-new-dir> --from <previous-installation> [--apply] [--reload] | verify <dir> | uninstall <dir> [--apply] [--reload] | init <absolute-repo> [--routing-from <absolute-json>] [--apply] | routes <absolute-repo> [--paseo-home <absolute-home>] [--out <path>] | inventory [--paseo-home <absolute-home>] | agents [--paseo-home <absolute-home>] | prepare <request.json> [--check | --emit create | --schema] [--out <path>] | prepare-handoff <request.json> [--check | --emit create | --schema] [--out <path>] | materialize <repository> --from <source-repository> [--include <repo-path>]... [--paseo-home <absolute-home>] [--apply] | monitor <request.json> | route-decide <request.json> [--schema] [--out <path>] [--paseo-home <absolute-home>] | notebook <repository> [--paseo-home <absolute-home>] | instructions <role> | status [--paseo-home <absolute-home>] | local-target [--paseo-home <absolute-home>]');
