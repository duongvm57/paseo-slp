...
import { usePeerPoolCard } from "./cards/peer-pool.ts";
...
export function ManagerSurface({ host, layout, theme }: PluginSurfaceProps) {
  ...
  // state and save/reload/import/copy — cards/peer-pool.ts. `form` and
  // `featureKeys` feed the catalog-demand computation below; the caches,
  ...
  const neededFeatureKeys = routing.featureKeys.concat(poolFeatureKeys);
