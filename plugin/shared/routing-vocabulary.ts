// plugin/shared/routing-vocabulary.ts — the Manager surface's mirror of
// src/routing-vocabulary.mjs, the package's canonical routing-criteria
// vocabulary (docs/spec/routing-criteria.md §2–§4, §6). The shared-module
// boundary cannot import package code and the installed runtime ships src/
// only, so neither side can import the other: this file is a verbatim data
// mirror, and tests/routing-criteria.test.mjs pins both sides to identical
// content under the same ROUTING_VOCABULARY_VERSION. Edit src/ first, then
// mirror — never let the two drift.
